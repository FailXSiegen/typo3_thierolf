		...
		if ($resolved) {
			...
			if ($mediaTypeSplit == '.js') {
				if ($addUnique) {
					...
					($moveToFooter)
						? GeneralUtility::makeInstance(PageRenderer::class)->addJsFooterFile($resolved)
						: GeneralUtility::makeInstance(PageRenderer::class)->addJsFile($resolved);
				}
			...
			// Stylesheet processing
				...
				if ($addUnique) {
					...
					GeneralUtility::makeInstance(PageRenderer::class)->addCssFile($resolved);
				}
			}
		}
	}
